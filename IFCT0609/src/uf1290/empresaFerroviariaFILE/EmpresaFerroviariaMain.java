...
//				bufferedReader
			...
			)	
		{
			...
			while(linea != null) {
				// si lo que queremos es reconstruir los "objetos" guardados hay que parsear Strings de objetos que contienen objetos, etc 
				// .. esto se complica.. es cuando viene al rescate la serialización.
				// nuestras clases tienen que implementar Serializable 
				// Podemos utilizar una coleccion/vector que implemente Serializable y así guardamos todos de golpe.
			...
			//simplemente mostramos por pantalla lo leído
			System.out.println("Mostramos contenido del ARCHIVO");
