...
//	Operaciones
	...
	public EsferaAbstracta() {}
	
	public EsferaAbstracta(float radio, String color) {
		this.radio=radio;
		this.color = color;
	}
	
	public abstract double getPerimetro(); // los métodos abstractos debe implementarlos las clases derivadas
